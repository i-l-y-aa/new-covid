  ...
  return (
    ...
    <Container>
      ...
      <div><img src={Zyatkov} align="left" width={320} ></img></div>
        ...
        <div class="row ps-4"><p><a href="https://covid19-modeling.ru/data/Zyatkov_N._CV_2024_ru.pdf">Резюме</a></p></div>
        ...
        <p>2 место на 5 Международной научной студенческой конференции "Студент и научно-технический прогресс", Новосибирский государственный университет, Новосибирск, Россия (2013).</p>
