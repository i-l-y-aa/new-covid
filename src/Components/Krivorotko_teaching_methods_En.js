...
<div class="row my-4 ps-4"><p class="lead">Numerical methods for solving inverse and incorrect problems in biology (immunology, epidemiology, pharmacokinetics), medicine (thermoacoustics, biostatistics), mathematical physics (geophysics, tsunami, acoustics), economics and social processes are studied. Special attention is paid to numerical regularization of inverse problems, evaluation of conditional stability of solutions to inverse problems, and identifiability.\</p></div>
        ...
        <div class="row ps-4"><p class="lead"><h4>Lecture 1</h4></p></div>
        <div class="row ps-4"><p class="lead"><h4>Introduction to inverse problems. Hadamard's example of the incorrectness of some inverse problems. Singular value decomposition.</h4></p></div>
        ...
        <div class="row ps-4 my-4"><p class="lead"></p></div>
        <div class="row ps-4"><p class="lead"><h4>Lecture 2</h4></p></div>
        <div class="row ps-4"><p class="lead"><h4>The incorrectness of the inverse problem of thermoacoustics, Dirichlet for the wave equation.</h4></p></div>
        ...
        <div class="row ps-4 my-4"><p class="lead"></p></div>
        <div class="row ps-4"><p class="lead"><h4>Lecture 3</h4></p></div>
        <div class="row ps-4"><p class="lead"><h4>M.M. Lavrentiev's regularization method. The regularization method of A.N. Tikhonov.</h4></p></div>
        ...
        <div class="row ps-4 my-4"><p class="lead"></p></div>
        <div class="row ps-4"><p class="lead"><h4>Lecture 4</h4></p></div>
        <div class="row ps-4"><p class="lead"><h4>The regularization method by A.N. Tikhonov (continued).</h4></p></div>
