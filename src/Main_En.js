...
export function Main_En() {
  ...
  const posts = [
    ...
    {id: 5, wid: '8rem', name: 'Tatyana Zvonareva', institution: 'Junior Researcher IM SB RAS',Phone:' 📞 +7(383) 329-7611',mail:'📩 t.a.zvonareva@math.nsc.ru', image: Zvonareva},
    ...
    {id: 9, wid: '8rem', name: 'Konstantin Koshelev', institution: 'Candidate of Physical and Mathematical Sciences, Senior Researcher at ISP RAN',Phone:'',mail:'📩 koshelev@iwep.ru', image: Question},
