...
export function News () {
  ...
  <article class="card_t">
    ...
    const postsA2 = [
      ...
      <article class="card_t">
        ...
        <div class="card_content_t">
        <h5 class="card_title_t">5 февраля пройдёт семинар лаборатории на тему «Математическое моделирование распространения эпидемий с учётом социальных, экономических и экологических процессов»</h5>
        <h5 class="card_descr_t lead">04.02.2025 </h5>
        </div>
      </article></a>
    </li></ul>,eventKey: "A2",eventKey: "all"},
      {id: 2, name: <ul class="cards_t "><li class="cards_item_t">
  ...
  <article class="card_t">
    ...
    <h5 class="card_descr_t lead">20.11.2024 </h5>
    </div>
  </article></a>
</li></ul>,eventKey: "A2",eventKey: "all"},
      {id: 3, name: <ul class="cards_t "><li class="cards_item_t">
  ...
  <article class="card_t">
    ...
    <h5 class="card_title_t my-4">14 ноября пройдёт семинар лаборатории на тему «Моделирование острых и хронических инфекций»</h5>
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="card_title_t my-3">18 июля пройдёт семинар лаборатории на тему «Полуконтролируемая сегментация медицинских изображений: Обзор»</h5>
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="my-2 card_title_t">4 июля пройдёт семинар лаборатории на тему «Применение PINN в SIR модели игры среднего поля»</h5>
    <h5 class="my-4 card_descr_t lead">21.06.2024 </h5>
      ...
      <article class="card_t">
        ...
        <div class="card_content_t">
        <h5 class="card_title_t my-1">20 июня пройдёт семинар лаборатории на тему «Рассуждения о методах проверки временных рядов на стационарность»</h5>
...
const postsall  = [
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="card_title_t my-1">5 февраля пройдёт семинар лаборатории на тему «Математическое моделирование распространения эпидемий с учётом социальных, экономических и экологических процессов»</h5>
  ...
  <article class="card_t">
    ...
    <h5 class="card_descr_t lead my-3">20.11.2024 </h5>
    </div>
  </article></a>
</li></ul>,eventKey: "A2",eventKey: "all"},
  {id: 3, name: <ul class="cards_t "><li class="cards_item_t">
  ...
  <article class="card_t">
    ...
    <h5 class="card_descr_t lead my-3">07.11.2024 </h5>
    </div>
  </article></a>
</li></ul>,eventKey: "A2",eventKey: "all"},
  {id: 4, name: <ul class="cards_t "><li class="cards_item_t">
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="card_title_t my-1">Cотрудники лаборатории примут участие в Международной конференции ПОСТГЕНОМ’2024, на которой с результатами работы выступит заведующий лабораторией Криворотько О.И.</h5>
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="card_title_t my-4">Сотрудники лаборатории примут участие в IV конференции математических центров России</h5>
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="my-2 card_title_t">В Новосибирской области проходит акция "Наука рядом"</h5>
    <h5 class="my-4 card_title_t"></h5>
    <p class="my-4 card_descr_t lead">10.07.2024</p>
    </div>
  </article></a>
</li></ul>,eventKey: "A2",eventKey: "all"},
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="my-2 card_title_t">18 июля пройдёт семинар лаборатории на тему «Полуконтролируемая сегментация медицинских изображений: Обзор»</h5>
  ...
  <article class="card_t">
    ...
    <div class="card_content_t">
    <h5 class="my-2 card_title_t">Ученые НГУ разрабатывают модель для прогнозирования развития осложнений инфекционных заболеваний</h5>
