...
export function Life_d () {
  ...
  return (
    ...
    <div class="row my-4 ps-4"><h2>Заведующий лабораторией Криворотько О.И. примет участие в заседаниях IV Конгресса молодых учённых</h2></div>
    <div class="row ps-4 my-4"><p class="lead"></p></div>
    <div class="row ps-4 my-4"><p class="lead"></p></div>
    <div class="row ps-4 my-4"><p class="lead"></p></div>
    <div class="row ps-4 my-4"><p class="lead"></p></div>
    <hr></hr>
    <div class="row ps-4 my-4"><p class="lead">С 27-го по 29-ое ноября пройдёт IV Конгресс молодых учённых, в котором примет участие заведующий лабораторией <a rel="noopener" target="_blank" href='/Krivorotko_info'>Криворотько О.И.</a></p></div>
