  ...
  return (
    <>
      ...
      <Container>
        ...
        <div className="row my-4"><p className="lead">Презентацию доклада можно увидеть по <a rel="noopener" target="_blank" href="https://covid19-modeling.ru/data/Моделирование_острых_и_хронических_инфекций.pdf">ссылке</a>.</p></div>
