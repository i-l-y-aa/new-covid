  ...
  return (
    <>
      ...
      <Container>
        ...
        <div class="row my-4"><p class="lead">The presentation of the report can be seen at the <a rel="noopener" target="_blank" href="https://covid19-modeling.ru/data/Семинар 26.09.pdf">link</a>.</p></div>
