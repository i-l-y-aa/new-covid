...
const regions = [
  ...
  getRegionData(43, "https://server.covid19-modeling.ru/api/csvTub/udmurtia", "udmurtia", "Удмуртская Республика", "Удмуртская Республика удмуртская республика","Приволжский федеральный округ","Ижевск", "1 434 557  ч.", "42 061 км²", "34,11 чел./км²"),
  getRegionData(44, "https://server.covid19-modeling.ru/api/csvTub/chuvashia", "chuvashia", "Чувашская Республика", "Чувашская Республика чувашская республика","Приволжский федеральный округ","Чебоксары", "1 167 061 ч.", "18 343 км²", "63,62 чел./км²"),
  getRegionData(45, "https://server.covid19-modeling.ru/api/csvTub/perm", "perm", "Пермский край", "Пермский край пермский край","Приволжский федеральный округ","Пермь", "2 495 266 ч.", "160 236 км²", "15,57 чел./км²"),
  getRegionData(46, "https://server.covid19-modeling.ru/api/csvTub/kirov", "kirov", "Кировская область", "Кировская область кировская область","Северо-Кавказский федеральный округ","Киров", "1 129 935 ч.", "120 400 км²", "9,39 чел./км²"),
  getRegionData(47, "https://server.covid19-modeling.ru/api/csvTub/nizhniynovgorod", "nizhniynovgorod", "Нижегородская область", "Нижегородская область нижегородская область","Северо-Кавказский федеральный округ","Нижний Новгород", "3 060 335 ч.", "76 624 км²", "39,94 чел./км²"),
  getRegionData(48, "https://server.covid19-modeling.ru/api/csvTub/orenburg", "orenburg", "Оренбургская область", "Оренбургская область оренбургская область","Северо-Кавказский федеральный округ","Оренбург", "1 828 656 ч.", "123 702 км²", "14,78 чел./км²"),
  getRegionData(49, "https://server.covid19-modeling.ru/api/csvTub/penza", "penza", "Пензенская область", "Пензенская область пензенская область","Приволжский федеральный округ","Пенза", "1 236 113 ч.", "43 352 км²", "28,51 чел./км²"),
  getRegionData(50, "https://server.covid19-modeling.ru/api/csvTub/samara", "samara", "Самарская область", "Самарская область самарская область","Приволжский федеральный округ","Самара", "3 127 842 ч.", "53 565 км²", "58,39 чел./км²"),
  getRegionData(51, "https://server.covid19-modeling.ru/api/csvTub/saratov", "saratov", "Саратовская область", "Саратовская область саратовская область","Приволжский федеральный округ","Саратов", "2 385 163  ч.", "101 240 км²", "23,56 чел./км²"),
  getRegionData(52, "https://server.covid19-modeling.ru/api/csvTub/ulyanovsk", "ulyanovsk", "Ульяновская область", "Ульяновская область ульяновская область","Приволжский федеральный округ","Ульяновск", "1 172 782 ч.", "37 181 км²", "31,54 чел./км²"),
  getRegionData(53, "https://server.covid19-modeling.ru/api/csvTub/kurgan", "kurgan", "Курганская область", "Курганская область курганская область","Уральский федеральный округ","Курган", "753 002  ч.", "71 488 км²", "10,53 чел./км²"),
  getRegionData(54, "https://server.covid19-modeling.ru/api/csvTub/sverdlov", "sverdlov", "Свердловская область", "Свердловская область свердловская область","Уральский федеральный округ","Екатеринбург", "4 222 695 ч.", "194 226 км²", "21,73 чел./км²"),
  getRegionData(55, "https://server.covid19-modeling.ru/api/csvTub/tumen", "tumen", "Тюменская область", "Тюменская область тюменская область","Уральский федеральный округ","Тюмень", "3 890 800 ч.", "160 122 км²", "2,66 чел./км²"),
  getRegionData(56, "https://server.covid19-modeling.ru/api/csvTub/chelyabinsk", "chelyabinsk", "Челябинская область", "Челябинская область челябинская область","Уральский федеральный округ","Челябинск", "3 395 798 ч.", "88 529 км²", "38,36 чел./км²"),
  getRegionData(57, "https://server.covid19-modeling.ru/api/csvTub/respaltay", "respaltay", "Республика Алтай", "Республика Алтай республика алтай","Сибирский федеральный округ","Горно-Алтайск", "210 765 ч.", "92 903 км²", "2,27 чел./км²"),
  getRegionData(58, "https://server.covid19-modeling.ru/api/csvTub/resptyva", "resptyva", "Республика Тыва", "Республика Тыва республика тыва","Сибирский федеральный округ","Кызыл", "337 544 ч.", "168 604 км²", "2,0 чел./км²"),
  getRegionData(59, "https://server.covid19-modeling.ru/api/csvTub/resphakasia", "resphakasia", "Республика Хакасия", "Республика Хакасия республика хакасия","Сибирский федеральный округ","Абакан", "528 175 ч.", "61 569 км²", "8,58 чел./км²"),
  getRegionData(60, "https://server.covid19-modeling.ru/api/csvTub/altay", "altay", "Алтайский край" , "Алтайский край алтайский край","Сибирский федеральный округ","Барнаул", "2 268 179 ч.", "167 996 км²", "13,5 чел./км²"),
  getRegionData(61, "https://server.covid19-modeling.ru/api/csvTub/krasnoyarsk", "krasnoyarsk", "Красноярский край", "Красноярский край красноярский край","Сибирский федеральный округ","Красноярск", "2 846 120 ч.", "2 366 797  км²", "1,2 чел./км²"),
  getRegionData(62, "https://server.covid19-modeling.ru/api/csvTub/irkutsk", "irkutsk", "Иркутская область", "Иркутская область иркутская область","Сибирский федеральный округ","Иркутск", "2 330 537 ч.", "774 846 км²", "3,01 чел./км²"),
  getRegionData(63, "https://server.covid19-modeling.ru/api/csvTub/kemerovo", "kemerovo", "Кемеровская область", "Кемеровская область кемеровская область","Сибирский федеральный округ","Кемерово", "2 547 684 ч.", "95 725 км²", "26,61 чел./км²"),
  getRegionData(64, "https://server.covid19-modeling.ru/api/csvTub/novosibirsk", "novosibirsk", "Новосибирская область", "Новосибирская область новосибирская область","Сибирский федеральный округ","Новосибирск", "2 779 375 ч.", "177 756 км²", "15,64 чел./км²"),
  getRegionData(65, "https://server.covid19-modeling.ru/api/csvTub/omsk", "omsk", "Омская область", "Омская область омская область","Сибирский федеральный округ","Омск", "1 879 548 ч.", "141 140 км²", "13,32 чел./км²"),
  getRegionData(66, "https://server.covid19-modeling.ru/api/csvTub/tomsk", "tomsk", "Томская область", "Томская область томская область","Сибирский федеральный округ","Томск", "1 043 385 ч.", "314 391 км²", "3,32 чел./км²"),
  getRegionData(67, "https://server.covid19-modeling.ru/api/csvTub/buryatia", "buryatia", "Республика Бурятия", "Республика Бурятия республика бурятия","Дальневосточный федеральный округ","Улан-Удэ", "971 922 ч.", "351 334 км²", "2,73 чел./км²"),
  getRegionData(68, "https://server.covid19-modeling.ru/api/csvTub/saha", "saha", "Республика Саха", "Республика Саха республика саха","Дальневосточный федеральный округ","Якутск", "1 001 664 ч.", "3 083 523 км²", "0,32 чел./км²"),
  getRegionData(69, "https://server.covid19-modeling.ru/api/csvTub/zabaikalsky", "zabaikalsky", "Забайкальский край", "Забайкальский край забайкальский край","Дальневосточный федеральный округ","Чита", "984 395 ч.", "168 604 км²", "2,28 чел./км²"),
  getRegionData(70, "https://server.covid19-modeling.ru/api/csvTub/kamchatsky", "kamchatsky", "Камчатский край", "Камчатский край камчатский край","Дальневосточный федеральный округ","Петропавловск-Камчатский", "288 947 ч.", "464 300 км²", "0,62 чел./км²"),
  getRegionData(71, "https://server.covid19-modeling.ru/api/csvTub/primorsk", "primorsk", "Приморский край" , "Приморский край приморский край","Дальневосточный федеральный округ","Владивосток", "1 806 393 ч.", "164 673 км²", "10,97 чел./км²"),
  getRegionData(72, "https://server.covid19-modeling.ru/api/csvTub/habarovsk", "habarovsk", "Хабаровский край", "Хабаровский край хабаровский край","Дальневосточный федеральный округ","Хабаровск", "1 278 132 ч.", "787 633  км²", "1,62 чел./км²"),
  getRegionData(73, "https://server.covid19-modeling.ru/api/csvTub/amursk", "amursk", "Амурская область", "Амурская область амурская область","Дальневосточный федеральный округ","Благовещенск", "750 083 ч.", "361 908 км²", "2,20 чел./км²"),
  getRegionData(74, "https://server.covid19-modeling.ru/api/csvTub/magadan", "magadan", "Магаданская область", "Магаданская область магаданская область","Дальневосточный федеральный округ","Магадан", "133 387 ч.", "462 464 км²", "0,29 чел./км²"),
  getRegionData(75, "https://server.covid19-modeling.ru/api/csvTub/sahalin", "sahalin", "Сахалинская область", "Сахалинская область сахалинская область","Дальневосточный федеральный округ","Южно-Сахалинск", "457 590 ч.", "87 101 км²", "5,25 чел./км²"),
  getRegionData(76, "https://server.covid19-modeling.ru/api/csvTub/evreiskaya", "evreiskaya", "Еврейская автономная область", "Еврейская автономная область еврейская автономная область","Дальневосточный федеральный округ","Биробиджан", "145 802 ч.", "36 300 км²", "4,02 чел./км²"),
  getRegionData(77, "https://server.covid19-modeling.ru/api/csvTub/chukotsk", "chukotsk", "Чукотский автономный округ", "Чукотский автономный округ чукотский автономный округ","Дальневосточный федеральный округ","Анадырь", "48 029 ч.", "721 481 км²", "0,07 чел./км²"),
...
const regionsSoc = [
  ...
  getRegionData(43, "https://server.covid19-modeling.ru/api/csvSocTub/udmurtia", "udmurtia", "Удмуртская Республика", "Удмуртская Республика удмуртская республика","Приволжский федеральный округ","Ижевск", "1 434 557  ч.", "42 061 км²", "34,11 чел./км²"),
  getRegionData(44, "https://server.covid19-modeling.ru/api/csvSocTub/chuvashia", "chuvashia", "Чувашская Республика", "Чувашская Республика чувашская республика","Приволжский федеральный округ","Чебоксары", "1 167 061 ч.", "18 343 км²", "63,62 чел./км²"),
  getRegionData(45, "https://server.covid19-modeling.ru/api/csvSocTub/perm", "perm", "Пермский край", "Пермский край пермский край","Приволжский федеральный округ","Пермь", "2 495 266 ч.", "160 236 км²", "15,57 чел./км²"),
  getRegionData(46, "https://server.covid19-modeling.ru/api/csvSocTub/kirov", "kirov", "Кировская область", "Кировская область кировская область","Северо-Кавказский федеральный округ","Киров", "1 129 935 ч.", "120 400 км²", "9,39 чел./км²"),
  getRegionData(47, "https://server.covid19-modeling.ru/api/csvSocTub/nizhniynovgorod", "nizhniynovgorod", "Нижегородская область", "Нижегородская область нижегородская область","Северо-Кавказский федеральный округ","Нижний Новгород", "3 060 335 ч.", "76 624 км²", "39,94 чел./км²"),
  getRegionData(48, "https://server.covid19-modeling.ru/api/csvSocTub/orenburg", "orenburg", "Оренбургская область", "Оренбургская область оренбургская область","Северо-Кавказский федеральный округ","Оренбург", "1 828 656 ч.", "123 702 км²", "14,78 чел./км²"),
  getRegionData(49, "https://server.covid19-modeling.ru/api/csvSocTub/penza", "penza", "Пензенская область", "Пензенская область пензенская область","Приволжский федеральный округ","Пенза", "1 236 113 ч.", "43 352 км²", "28,51 чел./км²"),
  getRegionData(50, "https://server.covid19-modeling.ru/api/csvSocTub/samara", "samara", "Самарская область", "Самарская область самарская область","Приволжский федеральный округ","Самара", "3 127 842 ч.", "53 565 км²", "58,39 чел./км²"),
  getRegionData(51, "https://server.covid19-modeling.ru/api/csvSocTub/saratov", "saratov", "Саратовская область", "Саратовская область саратовская область","Приволжский федеральный округ","Саратов", "2 385 163  ч.", "101 240 км²", "23,56 чел./км²"),
  getRegionData(52, "https://server.covid19-modeling.ru/api/csvSocTub/ulyanovsk", "ulyanovsk", "Ульяновская область", "Ульяновская область ульяновская область","Приволжский федеральный округ","Ульяновск", "1 172 782 ч.", "37 181 км²", "31,54 чел./км²"),
  getRegionData(53, "https://server.covid19-modeling.ru/api/csvSocTub/kurgan", "kurgan", "Курганская область", "Курганская область курганская область","Уральский федеральный округ","Курган", "753 002  ч.", "71 488 км²", "10,53 чел./км²"),
  getRegionData(54, "https://server.covid19-modeling.ru/api/csvSocTub/sverdlov", "sverdlov", "Свердловская область", "Свердловская область свердловская область","Уральский федеральный округ","Екатеринбург", "4 222 695 ч.", "194 226 км²", "21,73 чел./км²"),
  getRegionData(55, "https://server.covid19-modeling.ru/api/csvSocTub/tumen", "tumen", "Тюменская область", "Тюменская область тюменская область","Уральский федеральный округ","Тюмень", "3 890 800 ч.", "160 122 км²", "2,66 чел./км²"),
  getRegionData(56, "https://server.covid19-modeling.ru/api/csvSocTub/chelyabinsk", "chelyabinsk", "Челябинская область", "Челябинская область челябинская область","Уральский федеральный округ","Челябинск", "3 395 798 ч.", "88 529 км²", "38,36 чел./км²"),
  getRegionData(57, "https://server.covid19-modeling.ru/api/csvSocTub/respaltay", "respaltay", "Республика Алтай", "Республика Алтай республика алтай","Сибирский федеральный округ","Горно-Алтайск", "210 765 ч.", "92 903 км²", "2,27 чел./км²"),
  getRegionData(58, "https://server.covid19-modeling.ru/api/csvSocTub/resptyva", "resptyva", "Республика Тыва", "Республика Тыва республика тыва","Сибирский федеральный округ","Кызыл", "337 544 ч.", "168 604 км²", "2,0 чел./км²"),
  getRegionData(59, "https://server.covid19-modeling.ru/api/csvSocTub/resphakasia", "resphakasia", "Республика Хакасия", "Республика Хакасия республика хакасия","Сибирский федеральный округ","Абакан", "528 175 ч.", "61 569 км²", "8,58 чел./км²"),
  getRegionData(60, "https://server.covid19-modeling.ru/api/csvSocTub/altay", "altay", "Алтайский край", "Алтайский край алтайский край","Сибирский федеральный округ","Барнаул", "2 268 179 ч.", "167 996 км²", "13,5 чел./км²"),
  getRegionData(61, "https://server.covid19-modeling.ru/api/csvSocTub/krasnoyarsk", "krasnoyarsk", "Красноярский край", "Красноярский край красноярский край","Сибирский федеральный округ","Красноярск", "2 846 120 ч.", "2 366 797  км²", "1,2 чел./км²"),
  getRegionData(62, "https://server.covid19-modeling.ru/api/csvSocTub/irkutsk", "irkutsk", "Иркутская область", "Иркутская область иркутская область","Сибирский федеральный округ","Иркутск", "2 330 537 ч.", "774 846 км²", "3,01 чел./км²"),
  getRegionData(63, "https://server.covid19-modeling.ru/api/csvSocTub/kemerovo", "kemerovo", "Кемеровская область", "Кемеровская область кемеровская область","Сибирский федеральный округ","Кемерово", "2 547 684 ч.", "95 725 км²", "26,61 чел./км²"),
  getRegionData(64, "https://server.covid19-modeling.ru/api/csvSocTub/novosibirsk", "novosibirsk", "Новосибирская область", "Новосибирская область новосибирская область","Сибирский федеральный округ","Новосибирск", "2 779 375 ч.", "177 756 км²", "15,64 чел./км²"),
  getRegionData(65, "https://server.covid19-modeling.ru/api/csvSocTub/omsk", "omsk", "Омская область", "Омская область омская область","Сибирский федеральный округ","Омск", "1 879 548 ч.", "141 140 км²", "13,32 чел./км²"),
  getRegionData(66, "https://server.covid19-modeling.ru/api/csvSocTub/tomsk", "tomsk", "Томская область", "Томская область томская область","Сибирский федеральный округ","Томск", "1 043 385 ч.", "314 391 км²", "3,32 чел./км²"),
  getRegionData(67, "https://server.covid19-modeling.ru/api/csvSocTub/buryatia", "buryatia", "Республика Бурятия", "Республика Бурятия республика бурятия","Дальневосточный федеральный округ","Улан-Удэ", "971 922 ч.", "351 334 км²", "2,73 чел./км²"),
  getRegionData(68, "https://server.covid19-modeling.ru/api/csvSocTub/saha", "saha", "Республика Саха", "Республика Саха республика саха","Дальневосточный федеральный округ","Якутск", "1 001 664 ч.", "3 083 523 км²", "0,32 чел./км²"),
  getRegionData(69, "https://server.covid19-modeling.ru/api/csvSocTub/zabaikalsky", "zabaikalsky", "Забайкальский край", "Забайкальский край забайкальский край","Дальневосточный федеральный округ","Чита", "984 395 ч.", "168 604 км²", "2,28 чел./км²"),
  getRegionData(70, "https://server.covid19-modeling.ru/api/csvSocTub/kamchatsky", "kamchatsky", "Камчатский край", "Камчатский край камчатский край","Дальневосточный федеральный округ","Петропавловск-Камчатский", "288 947 ч.", "464 300 км²", "0,62 чел./км²"),
  getRegionData(71, "https://server.covid19-modeling.ru/api/csvSocTub/primorsk", "primorsk", "Приморский край" , "Приморский край приморский край","Дальневосточный федеральный округ","Владивосток", "1 806 393 ч.", "164 673 км²", "10,97 чел./км²"),
  getRegionData(72, "https://server.covid19-modeling.ru/api/csvSocTub/habarovsk", "habarovsk", "Хабаровский край", "Хабаровский край хабаровский край","Дальневосточный федеральный округ","Хабаровск", "1 278 132 ч.", "787 633  км²", "1,62 чел./км²"),
  getRegionData(73, "https://server.covid19-modeling.ru/api/csvSocTub/amursk", "amursk", "Амурская область", "Амурская область амурская область","Дальневосточный федеральный округ","Благовещенск", "750 083 ч.", "361 908 км²", "2,20 чел./км²"),
  getRegionData(74, "https://server.covid19-modeling.ru/api/csvSocTub/magadan", "magadan", "Магаданская область", "Магаданская область магаданская область","Дальневосточный федеральный округ","Магадан", "133 387 ч.", "462 464 км²", "0,29 чел./км²"),
  getRegionData(75, "https://server.covid19-modeling.ru/api/csvSocTub/sahalin", "sahalin", "Сахалинская область", "Сахалинская область сахалинская область","Дальневосточный федеральный округ","Южно-Сахалинск", "457 590 ч.", "87 101 км²", "5,25 чел./км²"),
  getRegionData(76, "https://server.covid19-modeling.ru/api/csvSocTub/evreiskaya", "evreiskaya", "Еврейская автономная область", "Еврейская автономная область еврейская автономная область","Дальневосточный федеральный округ","Биробиджан", "145 802 ч.", "36 300 км²", "4,02 чел./км²"),
  getRegionData(77, "https://server.covid19-modeling.ru/api/csvSocTub/chukotsk", "chukotsk", "Чукотский автономный округ", "Чукотский автономный округ чукотский автономный округ","Дальневосточный федеральный округ","Анадырь", "48 029 ч.", "721 481 км²", "0,07 чел./км²"),
